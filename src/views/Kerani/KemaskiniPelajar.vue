<template>
    <div class="bg-slate-50 w-full min-h-screen flex">
        ...
        <div class="w-full px-12 py-4">
            ...
            <RouterView
                @show-component="receiveShowComponentFromChild"
                v-if="studentNotSubject"
            />
            <div v-if="parentShowComponentValue && studentNotSubject">
                <!-- Maklumat Kelas -->
                            ...
                            >
                                ...
                                >
                                    <div>
                                        ...
                                        <p
                                            class="font-normal text-xs text-left"
                                        >
...
export default {
    ...
    data() {
        return {
            ...
            updatedStudentData: "",
            loading: false,
            parentShowComponentValue: false,
        };
    },
    ...
    methods: {
        receiveShowComponentFromChild(showComponentValue) {
            this.parentShowComponentValue = showComponentValue;
        },
        ...
        async deleteData() {
            ...
            this.loading = false;
            this.toast.warning("Subjek Telah Dipadam", {
                timeout: 3000,
            });
        },
