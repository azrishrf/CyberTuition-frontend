                    ...
                    >
                        <div>
                            ...
                            <p class="font-normal text-xs text-left">
                                Adakah anda pasti membatalkan resit bank yang
                                dimuat naik oleh pelajar ini?
                            </p>
...
export default {
    ...
    methods: {
        ...
        cancelReceiptBank() {
            this.loading = true;
            // change status to belum dibayar
            axios.put(
                baseAPI +
                    `/api/tuitionfee/deletereceiptbank/${this.tuitionFeeData.idTuitionFee}`
            );
