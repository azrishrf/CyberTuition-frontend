    ...
    <div class="bg-slate-50 w-full min-h-screen flex">
        ...
        <div class="w-full px-12 py-4">
            ...
            <div v-if="!loading">
                <!-- Content -->
                <div
                    class="bg-white my-6 rounded-2xl py-5 px-11 shadow-login flex"
                >
                    <div class="flex-1">
                ...
                >
                    ...
                    >
                        ...
                        <ul class="list-decimal list-inside">
                            <li class="mb-2">
                                Rujuk penyata kewangan pelajar yang tertera di
                                atas dan sahkan ketepatan jumlah pembayaran yang
                                dipaparkan.
                            </li>
                            <li class="mb-2">
                            ...
                            <li class="mb-2">
                                Klik pada butang "Bayaran Diterima" di bawah
                                untuk menunjukkan bahawa pembayaran telah
                        ...
                        >
                            <div>
                                ...
                                <h1 class="font-semibold text-base text-left">
                                    Pembayaran Yuran Secara Tunai
                                </h1>
                                <p class="font-normal text-xs text-left">
                                    Adakah pelajar telah membuat bayaran penuh?
                                </p>
