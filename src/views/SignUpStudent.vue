    ...
    <div class="bg-slate-50 w-full min-h-screen pb-16">
        ...
        >
            ...
            <div class="flex flex-wrap gap-4 lg:gap-8 pb-5">
                <button
                    type="button"
                    class="relative shadow-login h-[155px] py-4 px-2 items-center rounded-2xl w-[138px] lg:w-36 transition duration-300 ease-in-out hover:scale-110 flex flex-col removeblue"
                    v-bind:class="{
